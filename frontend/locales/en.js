...
export default {
  ...
  // Onboarding Wizard
  onboarding: {
    welcome: "Welcome to Glitch Goblin",
    subtitle: "Your desktop Kanban board for development projects",
    letsStart: "Let\u2019s go!",
    next: "Next",
    back: "Back",
    finish: "Finish",
    ...
    notGitRepo: "Not a Git repository \u2014 please choose a project with Git initialized",
    checking: "Checking...",
    projectName: "Project name",
    ticketPrefix: "Ticket prefix",
    ticketPrefixHint: "e.g. \"GG\" yields GG-001, GG-002, ...",
    claudeCheck: "Claude Code Detection",
    claudeFound: "Claude Code found",
    claudeNotFound: "Claude Code not found",
    claudePathHint: "Path to Claude CLI (empty = default \"claude\")",
